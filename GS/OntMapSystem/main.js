...
$(window).load(function () {
	...
	$('#end_element').click(function (event) {
		find_treeObj($('#tree'), $('#end_element'), 'http://kgc.knowledge-graph.jp/ontology/kgc.owl#Person');
...
function init() {
	...
	find_tree(new TreeData('type'), 'http://kgc.knowledge-graph.jp/ontology/kgc.owl#Person', function (treeData) {
...
function make_link() {
	...
	//        var query = make_route_query($('#start_element0').val(), $('#end_element0').val(), query_index, lang, type, limit, offset);
	var query = make_route_query($('#start_element2').text(), $('#end_element2').text(), query_index, lang, type, limit, offset);
	//alert(query);
