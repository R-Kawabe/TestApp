 ...
 * @param childID
 */
TreeData.prototype.addSubClass = function(myID, childID, isRoot){
	var myNode = this.getNodeJson(myID);

	if (this.rootNode == null && isRoot){
...
TreeData.prototype.getNodeJson = function(id){
	...
	if (ret == undefined){
		ret = {'name' : this.labelList[id].htmlEscape(), 'id' : id, 'resource' : this.resourceList[id], 'open' : true, 'children' : []}; // データ形式はどうにかする
